...
- Acceptance 3 (M029 gate mechanical): PASS — GATE_REGISTER G01..G07 all PENDING, gate BLOCKED
- Tests: tests/m003 (5 checks) — run in CI + locally
- Residuals: every real-world signoff pending a named human; no legal/clinical
  conclusion fabricated; synthetic-only environments unchanged.
